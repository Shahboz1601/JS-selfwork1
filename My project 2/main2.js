...
function Event1(){
    ...
    text1.innerText = "Kesim yuzasi: w=m*h^2 (m^2)"
    ...
    trapContain1.innerHTML='<input type="number" name="username" id="" class="login-form-field1" placeholder="m ni kiriting">';
...
function Event4(){
    let text1 = document.createElement("h5");
    text1.className = "texts"
    text1.innerText = "Xo`llanganlik perimetri: 𝜒=2*h*√(1+𝑚^2 )(m)"  
    trapContain.appendChild(text1);

    let text2 = document.createElement("h5");
    text2.className = "texts"
    text2.innerText = "m=kanal tubi eni(m)"
    trapContain.appendChild(text2);
...
function Event5(){
    let text1 = document.createElement("h5");
    text1.className = "texts"
    text1.innerText = "Gidravlik radius: R=w/𝜒 yoki  m*h/2*√(1+𝑚^2 )"  
    trapContain.appendChild(text1);
